                    ...
                    <tbody class="bg-light">
                        ...
                        foreach ($data_pelanggan as $key => $pelanggan) { ?>
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="<?php echo "edit_data_view.php?key=".$key; ?>" class="btn btn-warning ">Edit Data</a>
                                    <a href="<?php echo "edit_data_view.php?id_pelanggan?=".$pelanggan->id_pelanggan; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
